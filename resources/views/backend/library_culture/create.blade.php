           ...
           {{-- <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                    @if(isset($library_culture))
                        <div class="add_image_div add_image_div_red"
                             style="background-image: url({{ $library_culture->image }});"></div>
                    @else
                        <div class="add_image_div add_image_div_red">
                        </div>
                    @endif
            ...
            <div class="row">
                ...
                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10">
                    <textarea class="form-control" id="description" name="description" placeholder="Enter Description" rows="10" cols="50">{{ isset($library_culture)? $library_culture->description:Request::old('description') }}</textarea>
            ...
            <div class="row">
                ...
                <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
                    <input type="submit" name="submit" value="{{isset($library_culture)? 'UPDATE' : 'ADD'}}" class="form-control btn-primary">
                </div>
                <div class="col-lg-1 col-md-1 col-sm-1 col-xs-1">
