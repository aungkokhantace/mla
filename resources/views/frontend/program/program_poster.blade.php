    ...
    <div class="container">
        ...
        <div class="col-md-3">
                <div class="list-group">
                    ...
                    <a href="call_for_paper.html#paper" class="list-group-item">Call for Papers</a>
                    <a href="poster.html#poster" class="list-group-item active-sub">Poster Sessions</a>
            ...
            <form class="form-horizontal">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-4">
                  <input id="title" name="title" type="text" placeholder="" class="form-control input-lg">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-4">
                  <input id="author_affilliation" name="author_affilliation" type="text" placeholder="" class="form-control input-lg">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-4">
                  <input id="email" name="email" type="text" placeholder="" class="form-control input-lg">
