        ...
        <div class="row sidebar-page">
            ...
            <div class="col-md-3">
                <div class="list-group">
                    ...
                    <a href="convening.html#convening" class="list-group-item active-sub">Pre-conference Convencing</a>
            ...
            <!-- Content Column -->
            <div class="col-md-9" id="convening">
                <h2>PROGRAM >> PRE-CONFERENCE CONVENING</h2>
