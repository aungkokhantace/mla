...
<body>
    <section class="head-top">
       <div class="container">
        <div class="row">
            <div class="col-md-9">
            <img src="../mla_site/images/head1.jpg" class="img-responsive">
            </div>
            <div class="col-md-3">
    ...
    <header class="my-carousel">
                <img src="../mla_site/images/slide1.jpg" class="img-responsive">
    </header>
    ...
    <div class="container">
        ...
        <div class="col-md-3">
                <div class="list-group">
                    <a href="conference_reg_form.html#conference_reg_form" class="list-group-item">Conference Registration Form</a>
                    <a href="registration_fee_payment.html#reg_fee_payment" class="list-group-item active-sub">Registration Fees and Payment</a>
            ...
            <div class="col-md-9 reg_fee_payment" id="reg_fee_payment">
